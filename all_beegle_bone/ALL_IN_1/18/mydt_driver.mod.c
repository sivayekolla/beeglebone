...
MODULE_ALIAS("platform:mydt0");
MODULE_ALIAS("platform:mydt1");
MODULE_ALIAS("of:N*T*Cmycompany,mydt");
MODULE_ALIAS("of:N*T*Cmycompany,mydtC*");

MODULE_INFO(srcversion, "2227A6122FF68867F764CED");
